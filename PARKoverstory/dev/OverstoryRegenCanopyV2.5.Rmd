...
params: 
  ...
  sites: !expr c(1:7) # CHANGE THIS LINE to reflect site numbers, can put a range (1:7) or comma seperated numbers (1,2,3,4,5,6,7)
  class: !expr c(1:5) 
---
...
n_sites <- length(site)  #sets 'n_sites' as number of sites, if not all sites are measured in all years just enter site number manually 
...
if (n_sites >= 7 ) { #if sites are >= 7, the CI values will be bootstrapped
